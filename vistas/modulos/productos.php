        ...
        ======================================-->
                ...
                <div class="modal-body">
                  ...
                  ?>
                        ...
                        <!-- ENTRADA PARA NÚMERO DE FACTURA -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control input-lg" id="nuevoNumeroFactura"
                                    name="nuevoNumeroFactura" placeholder="Ingresar número de factura" required>
                            ...
                            <div class="col-xs-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control input-lg" id="editarPrecioVenta"
                                        name="editarPrecioVenta" step="any" min="0" readonly required>

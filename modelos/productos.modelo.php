...
class ModeloProductos{
	...
	static public function mdlIngresarProducto($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(id_categoria, num_factura, codigo, descripcion, imagen, stock, precio_compra, precio_venta) VALUES (:id_categoria, :num_factura, :codigo, :descripcion, :imagen, :stock, :precio_compra, :precio_venta)");
